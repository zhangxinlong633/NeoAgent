...
可复现的命令行样例、开箱组合与排错。**系统化操作说明请先读 [`manual.md`](manual.md)（使用手册）**；更短的复制清单见 [`../example/usage/`](../example/usage/)。
...
| 精简入口 | [`manual.md`](manual.md)；[`../example/usage/`](../example/usage/)；根 [`README.md`](../README.md) / [`README_zh.md`](../README_zh.md) |
